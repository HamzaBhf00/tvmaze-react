        ...
        <div className="container py-5">
          <div className="row mb-4">
            <div className="col-lg-5">
              ...
              <p className="font-italic text-muted">Somos una organización que organiza películas y series.</p>
            </div>
          </div>
          ...
          <div className="row text-center">
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4">
                ...
                <h5 className="mb-0">Hamza Boulahfa</h5><span className="small text-uppercase text-muted">CEO - Fundador</span>
            ...
            <div className="col-xl-3 col-sm-6 mb-5">
              <div className="bg-white rounded shadow-sm py-5 px-4">
                ...
                <h5 className="mb-0">Tom Sunderland</h5><span className="small text-uppercase text-muted">Ayudante</span>
                <ul className="social mb-0 list-inline mt-3">
                  <li className="list-inline-item">
                    <a href="#" className="social-link"><i className="fab fa-facebook"></i></a>
                  </li>                  <li className="list-inline-item">
